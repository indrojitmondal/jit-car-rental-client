...
import { AuthContext } from '../../../providers/AuthProvider'
import logInLottieAnimation from "../../../assets/lottiefiles/loginLottiefile.json";
...
const Login = () => {
    ...
    const { signIn, signInWithGoogle, user, loading, setUser, setLoading } = useContext(AuthContext)
